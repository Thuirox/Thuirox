...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:Cn,depthTest:!1,depthWrite:!1})}function Qa(){return new $n({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ho(),fragmentShader:`
		...
		`,blending:Cn,depthTest:!1,depthWrite:!1})}function el(){return new $n({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ho(),fragmentShader:`
...
`].filter(ts).join(`
`)),a=eo(a),a=cl(a,t),a=ul(a,t),o=eo(o),o=cl(o,t),o=ul(o,t),a=dl(a),o=dl(o),t.isWebGL2&&t.isRawShaderMaterial!==!0&&(C=`#version 300 es
